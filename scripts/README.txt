...
Note: 
 ...
 - TFE was previously called PCDF in the early phase of this study.
 - Original input data (ISIMIP2b daily river discharge data) is available from https://dataservices.gfz-potsdam.de/pik/showshort.php?id=escidoc:5046893.
